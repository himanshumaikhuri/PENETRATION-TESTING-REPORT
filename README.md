...
* `screenshots/01-whois-whatweb.png`
* `screenshots/02-nslookup-curl.png`
* `screenshots/03-wafw00f-dnsrecon.png`
* `screenshots/04-zenmap-scan-results.png`
* `screenshots/05-zenmap-topology.png`
